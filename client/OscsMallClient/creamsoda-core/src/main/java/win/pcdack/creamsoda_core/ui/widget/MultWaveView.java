...
public class MultWaveView extends View {
    ...
    //第四条
    private static final int TRANSLATE_X_SPEED_FOUR=7;
    ...
    public MultWaveView(Context context) {
        this(context,null);
    }

    public MultWaveView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initOffset() {
        ...
        mXOffsetSpeedTwo=ConvertUtils.dp2px(TRANSLATE_X_SPEED_TWO);
        mXOffsetSpeedThree=ConvertUtils.dp2px(TRANSLATE_X_SPEED_THREE);
        mXOffsetSpeedFour=ConvertUtils.dp2px(TRANSLATE_X_SPEED_FOUR);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTotalWidth; i++) {
            ...
            // 绘制第二条水波纹
            canvas.drawLine(i, mTotalHeight - mResetTwoYPositions[i] - 280, i,mTotalHeight, mWavePaint);

            canvas.drawLine(i, mTotalHeight - mResetThreeYPositions[i] - 200, i,mTotalHeight, mWavePaint);

            canvas.drawLine(i, mTotalHeight - mResetFourYPositions[i] - 50, i,mTotalHeight, mWavePaint);
        }
        // 改变两条波纹的移动点
